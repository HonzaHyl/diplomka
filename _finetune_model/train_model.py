...
if __name__ == '__main__':
    ...
    if USE_ARGS:
        ...
        if len(sys.argv) not in [3, 4]:
            raise Exception('Include the data, model folders and optionally resume checkpoint as arguments, e.g., python train_model.py data model [resume_checkpoint].')
    ...
    training_code(data_directory, model_directory, resume_checkpoint) 
